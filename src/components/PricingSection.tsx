    ...
    <section id="pricing" className="bg-white py-24 lg:py-32">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Monthly Access Card */}
          <Card className="group bg-white border-2 border-gray-100 rounded-3xl p-8 hover:border-gray-200 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] animate-fade-in">
            ...
            <CardContent className="p-0 space-y-6">
              ...
              <div className="pt-4">
                <Button className="w-full bg-black text-white hover:bg-gray-800 rounded-xl py-6 text-lg font-inter font-semibold transition-colors duration-200">
                  Unlock Full Access →
                </Button>
          ...
          <Card className="group bg-white border-2 border-black rounded-3xl p-8 relative hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] animate-fade-in" style={{ animationDelay: '0.2s' }}>
            {/* Best Value Badge */}
